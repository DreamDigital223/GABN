...
<head>
    ...
    <link rel="stylesheet" href="{{ url('css/tree-viewer.css')}}">
        ...
        <div class="right-side">
            <div class="right-content">
                <div id="one" class="content active fade in">
                    <h1><span>Nalika</span> - Nalika Admin Template</h1>
                    ...
                    <div class="created">
                        <p>
                            ...
                            <br> By: <a href="https://colorlib.com/wp/templates/" >Colorlib</a>
                            
                            
                            <br>
                            <br> Thank you for purchasing our theme. If you have any question, please feel free to contact us from <a href="https://colorlib.com/wp/templates/">here</a>.
                        </p>
                    </div>
                </div>
...
<p>The end of your pages, right before the closing "body" tag. Be sure to place js first, as our JavaScript plugins depend on them. </p>
	...
	<!-- summernote JS
        ...
        <script src="{{ url('js/summernote-active.js')}}"></script>
	</xmp>
</pre>
    ...
    <script src="{{ url('js/jstree.active.js')}}"></script>
